...
export const yunhanSects: Sect[] = [
  {
    ...
    region: "yunhan",
    description:
      "云汉大陆首屈一指的正道大宗，位于云汉最中心。六座山峰各有所长，宗门氛围亲密如家。长老们从小一起长大，关系特别好，互动频繁。",
    leader: "李扶光",
    ...
    mountains: [
        ...
        characters: [
          {
            ...
            sect: "紫霄宗·扶光山",
            description:
              '正道第一人，最有希望飞升的修士。为人跳脱潇洒，极具可靠感。虽然是最小的，但最可靠。上一世在飞升时发现"祂"的真相，灵魂侥幸逃脱，与真正的天道合作，以自身为代价倒转时光，使一切重来，并拉戴月槐进入这个世界，以"系统"身份引导他将司徊拉入正道。称席微为"二师姐"，称戴月槐为"师兄"。',
            specialty: "剑道、综合修为",
            status: "闭关中",
            quote: "",
        ...
        characters: [
          {
            ...
            sect: "紫霄宗·长留山",
            description:
              '紫霄宗大长老，擅长傀儡术与机关术。个性看似不靠谱，爱偷懒，实际上会偷偷观察弟子的学习情况。最喜欢种植药草。他设立了严格的修炼制度（学分制），使修仙界形成996勤修苦练的风气。实际上是来自异世界的穿越者，被上一世的李扶光（化身系统）拉入此界，目的是将司徊引向正道，对抗假天道"祂"。',
          ...
          },
          {
            ...
            sect: "紫霄宗·长留山",
            description:
              '戴月槐的亲传弟子，席微之子，云非堇的遗腹子。被假天道"祂"投放的"天道之书"引诱，成为"祂"的棋子。"祂"意图让他杀死司徊和天道转世袁霄强，使他以更深罪孽飞升，从而让"祂"变得更强。',
            specialty: "机关术",
            status: "在修",
            quote: "",
          },
          {
            ...
            sect: "紫霄宗·长留山",
            description:
              '戴月槐的亲传弟子，性格复杂。假天道"祂"故意催生其邪念，意图使其成为罪孽深重的邪修飞升。系统（上一世李扶光）引导戴月槐将他拉入正道。',
            specialty: "傀儡术",
            status: "在修",
            quote: "",
          },
      ...
      },
      {
        ...
        name: "青鸾山",
        description:
          "紫霄宗第二山，二长老席微所在。画修圣地，弟子皆为凡间孤苦无依的幼女，因此修炼刻苦，皆是修仙界出类拔萃的女修。",
        characters: [
          {
            id: "xiwei",
            name: "席微",
            ...
            sect: "紫霄宗·青鸾山",
            description:
              "画修，擅长作画。外表公正严肃，实则非常疼爱弟子，尤其是儿子席沐逍。青鸾山弟子皆为凡间孤苦无依的幼女，在她的教导下成为修仙界出类拔萃的女修。道侣云非堇于100年前战死，她随身携带云非堇留下的小荷包，经常给长留山的弟子们发糖吃。师父是前青鸾长老叶攸。",
            specialty: "画修",
            status: "在任",
            quote: "",
          ...
          },
          {
            ...
            sect: "紫霄宗·青鸾山",
            description:
              "上一任掌门唐夷的亲传弟子，席微的丈夫，原本的掌门。一百年前，白骨哀得知前青鸾长老叶攸渡劫失败、席微受重创，趁护山大阵被劫雷所破之际攻上青鸾山。紫霄宗全力前往禁地修复阵眼，云非堇独自迎战，为了保护山中的妻儿和其他弟子，以一己之力敌千人，最后身死道消。",
            specialty: "综合修为",
            status: "已故（100年前）",
            quote: "",
          },
  ...
  },
  {
    ...
    region: "yunhan",
    description:
      "位于云汉北部北溟，此地潮湿多雨，蛟人出没。山海轩守护着北溟的土地，能抵御蛟人的歌声。掌管云汉通往归墟的水路，其纯净的灵魂可召唤鲲鹏带路。",
    leader: "纪云山",
    location: "云汉大陆北部·北溟",
    specialty: "魂梦之术，特色武器梦铃，能感知灵魂波动，使用铃铛操控梦境。山海轩弟子灵魂纯净，可与鲲鹏沟通。",
    rules: ["守护北溟，抵御蛟人", "传承魂梦之术", "护送亡魂前往归墟", "保持灵魂纯净"],
    divisions: [
      {
        id: "tingchao",
        name: "听潮阁",
        description:
          "门主纪云山所在之地，对外作战与防御核心。类似于紫霄宗的扶光山与长留山的结合体，是山海轩最强的武装力量和行政中枢。",
        duty: "对外作战与防御核心",
        responsibilities: [
        ...
        characterTraits:
          "听潮阁弟子作风务实、坚毅，实战经验丰富。他们的眼神总是带着警惕，因为长期聆听潮声与蛟人的歌唱，他们的听觉异常敏锐，心志也极为坚定。",
        treasureName: "镇海螺",
        ...
        characters: [
          {
            ...
            sect: "山海轩·听潮阁",
            description:
              "山海轩掌门，守护北溟水路的领袖。性格沉稳睿智，深谙魂梦之术，能够与鲲鹏沟通，引导亡魂前往归墟。",
            specialty: "魂梦之术、鲲鹏沟通",
            status: "在任",
            quote: "",
          },
      ...
      },
      {
        ...
        name: "入梦台",
        description:
          "副门主贺明朝所在之地，魂梦研究与疗愈中心。此地是山海轩魂梦之术的根基与知识宝库，氛围最为宁静与神秘。",
        duty: "魂梦研究与疗愈中心",
        responsibilities: [
        ...
        characterTraits:
          "入梦台的弟子气质空灵，不喜言语，更善于通过灵魂波动进行交流。他们对梦境的理解远超常人，但也因此，部分弟子在现实与梦境的边界上显得有些模糊。",
        treasureName: "引梦灯",
      ...
      },
      {
        ...
        characterTraits:
          "观星楼的弟子兼具修士的灵性与工匠的严谨。他们对数字和阵法极为敏感，常常昼伏夜出，在星光最盛之时进行工作。",
        treasureName: "梦铃",
        treasureDescription:
          "山海轩弟子的标配法器，由观星楼统一制作。摇动时能发出清心凝神的音波，抵御心神侵扰，同时也是施展魂梦之术的重要媒介。",
        characters: [
          {
            id: "yuexichun",
            name: "越溪春",
    ...
    landmarks: [
      ...
      },
      {
        ...
        name: "魂林",
        description:
          "山海轩的神圣之地。每个弟子死亡后，魂魄归于魂林，与鲲鹏一起往生，等待下一次重生。林中树木皆为魂树，散发着淡淡的荧光。",
        type: "forest",
      },
      {
        id: "guixu-path",
  ...
  },
  {
    ...
    region: "yunhan",
    description:
      "以情报收集和暗杀闻名的神秘宗门。半月楼弟子行踪隐秘，遍布修仙界各处，掌握着无数秘密。楼中分为明暗两部，明部经营商业情报，暗部则执行暗杀任务。",
    leader: "未知",
    location: "云汉大陆南部·流影谷",
    specialty: "情报网络、暗杀术、易容术、追踪术",
    rules: ["情报至上，保密为先", "任务必达，不问缘由", "楼主身份永为秘密", "叛楼者，死"],
    divisions: [
      {
        id: "mingbu",
        name: "明部",
        ...
        characterTraits:
          "明部弟子善于交际，能言善辩，在修仙界中游刃有余。他们往往以商人身份示人，但实则个个都是情报高手。",
        treasureName: "千里传音符",
  ...
  },
  {
    ...
    region: "yunhan",
    description:
      "隐世宗门，位于云汉西部的水域深处。擅长水系法术和医术，尤其精通用水疗伤。宗门建于水下洞天之中，与世隔绝，弟子性格温和淡泊。",
    leader: "迦陵",
    location: "云汉大陆西部·沧澜水域",
    specialty: "水系法术、水疗医术、炼水成兵",
    rules: ["与世无争，潜心修行", "医者仁心，救死扶伤", "不轻易入世，除非天下大乱"],
    divisions: [
      {
        id: "bibo",
        name: "碧波殿",
  ...
  },
  {
    ...
    region: "yunhan",
    description:
      "佛门宗派，以音律和禅修闻名。天音寺僧人以佛法普度众生，用音律净化心灵。寺中晨钟暮鼓，梵音不绝，是修仙界著名的清修之地。",
    leader: "怀空大师",
    location: "云汉大陆北部·天音山",
    specialty: "佛门音律、禅修、梵音攻击",
    rules: ["慈悲为怀，普度众生", "晨钟暮鼓，不得懈怠", "戒杀生，除恶魔", "六根清净，心无旁骛"],
    divisions: [
      {
        id: "daxiong",
        name: "大雄宝殿",
  ...
  },
  {
    ...
    region: "yunhan",
    description:
      "云汉大陆上的神秘国度，外人不可进入。国内每天都在上演狗血言情戏码，爱恨情仇多到飞天，诡异到正经修士会绕着走。据说进入朝云国的修士，都会被卷入莫名其妙的情劫之中。",
    leader: "朝云君",
    location: "云汉大陆东南部·迷雾之境",
    specialty: "情丝术、心魔引诱、情劫布阵",
    rules: ["外人禁入，擅入者困于情劫", "国中之事，不得外传", "爱恨随心，生死由命"],
    members: [
      {
        id: "chaoyunjun",
        name: "朝云君",
        ...
        sect: "朝云国",
        description:
          "朝云国的神秘国主，容貌绝美，性别不明。擅长操控情丝，让人陷入情劫。据说朝云君本身就是一场未完的情劫化形而成。",
        specialty: "情丝术、情劫布阵",
        status: "在位",
        quote: "",
      },
    ...
    landmarks: [
      ...
      },
      {
        ...
        name: "情劫宫",
        description:
          "朝云国的核心建筑，宫中每日上演着各种爱恨情仇的戏码。据说进入此宫的人，都会看到自己最不愿面对的情劫。",
        type: "other",
      },
    ],
  },
...
export const rongzhouSects: Sect[] = [
  {
    ...
    region: "rongzhou",
    description:
      "戎州大陆顶尖剑修宗门，坚持最传统的剑修之道，崇尚个人剑道巅峰。长生门弟子剑意凌厉，以剑入道，追求剑道长生。",
    leader: "云负月",
    location: "戎州大陆中部·长生剑山",
    specialty: "传统剑修、剑意修炼、御剑飞行",
    rules: ["追求剑道极致", "以剑入道", "剑心通明，不染尘埃", "生死看淡，一剑破之"],
    divisions: [
      {
        id: "zhujiange",
        name: "铸剑阁",
  ...
  },
  {
    ...
    region: "rongzhou",
    description:
      "擅长通过琴音疗伤、驱邪、甚至影响战局。以琴音治疗和辅助术法闻名。宫中有林荀两家，自从一百年前林家掌握了修复神魂的办法，成了问琴仙宫掌握实权的家族。",
    leader: "林家家主",
    location: "戎州大陆东部·问琴峰",
    specialty: "琴音疗愈、辅助术法、神魂修复",
    rules: ["以琴入道", "医者仁心", "琴心不乱，则天下不乱", "神魂之术，不可外传"],
    divisions: [
      {
        id: "linfeng",
        name: "林家府",
      ...
      },
      {
        ...
        duty: "琴音攻击与辅助",
        responsibilities: ["琴音攻击：研习琴音的攻击之法", "辅助术法：用琴音辅助战斗", "琴艺传承：传承荀家琴道"],
  ...
  },
  {
    ...
    region: "rongzhou",
    description:
      "魔修聚集地，行事乖张，是正道的主要对立面。100年前曾趁紫霄宗护山大阵被破之际攻上青鸾山，导致云非堇战死。如今白骨哀在酆都建立了根据地，势力日渐壮大。",
    leader: "谢檀远",
    location: "戎州北部·昆仑地区·酆都",
    specialty: "魔修功法、白骨术、血祭之法",
    rules: ["弱肉强食", "实力为尊", "不择手段，达成目的", "背叛者，挫骨扬灰"],
    members: [
      {
        id: "xietanyuan",
        name: "谢檀远",
    ...
    landmarks: [
      {
        ...
        name: "酆都",
        description:
          "戎州北部的魔城，原城主应无昼已逝。如今酆都成为无人管辖之地，魔族聚集，白骨哀在此建立了根据地，成为白骨哀的一言堂。",
        type: "other",
      },
      {
        id: "baigu-hall",
  ...
  },
  {
    ...
    region: "rongzhou",
    description:
      '位于昆仑最北，传达天道启示的宗门。实则已被假天道"祂"的化身"柳玄之"渗透，可能影响整个修仙界的走向。归墟就位于禨祥宗旁边。',
    leader: "柳玄之",
    location: "戎州北部昆仑地区·归墟旁",
    specialty: "传达天道启示（实为假天道代言）、占卜预言、天机推演",
    rules: ["奉天道旨意", "传达启示", "顺天者昌，逆天者亡", "天机不可泄露"],
    members: [
      {
        id: "liuxuanzhi",
        name: "柳玄之",
    ...
    landmarks: [
      ...
      },
      {
        ...
        name: "不周天柱",
        description:
          "戎州著名的地理奇观，据说是魔气和灵气的共同发源地。天柱高耸入云，柱身有黑白两色交织，代表魔气与灵气的平衡。",
        type: "mountain",
      },
    ],
  },
  {
    ...
    region: "rongzhou",
    description:
      "原为戎州北部的重要城池，城主应无昼已逝。如今酆都已成无人管辖之地，魔族聚集，成为白骨哀的根据地和一言堂。城中阴气森森，常人不敢靠近。",
    leader: "应无昼（已逝）",
    location: "戎州北部·昆仑地区",
    specialty: "无（已成魔修聚集地）",
    rules: ["无规则，弱肉强食", "白骨哀说了算"],
    members: [
      {
        id: "yingwuzhou",
        name: "应无昼",
...
export const importantCharacters: Character[] = [
  {
    ...
    sect: "无门派",
    description:
      '魔族血统，天赋异禀。假天道"祂"故意催生他的邪念，意图使其成为罪孽深重的邪修飞升，从而让"祂"变得更强大。但在戴月槐（系统）的引导下，有可能被拉入正道，改变命运。',
    specialty: "魔族天赋",
    status: "关键变数",
    quote: "",
  },
...
export const formerElders: Character[] = [
  ...
  },
  {
    ...
    sect: "紫霄宗·青鸾山",
    description:
      "席微的师父，温柔的女修。曾试图渡劫飞升但失败，在劫雷下受损，导致护山大阵被破，间接引发了100年前的白骨哀攻山事件。",
    specialty: "画修",
    status: "已故（渡劫失败）",
    quote: "",
  },
