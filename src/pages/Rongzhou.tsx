...
import { rongzhouSects } from '@/data/sects';
      ...
      <header className="border-b border-border/50 bg-card/30 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-primary">戎州大陆</h1>
            <div className="w-24" />
          </div>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4 mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-3xl font-bold">戎州大陆</h2>
            </div>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
              位于世界右侧，地势复杂险峻。既有适合剑修的峻峭山脉，也有魔气滋生的昆仑死地。
              这里是剑道与魔修的交锋之地，充满了未知与危险。
            </p>
          </div>

          {/* 门派列表 */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {rongzhouSects.map((sect) => (
