      ...
      <main className="container mx-auto px-6 min-h-screen flex items-center justify-center">
        <div className="max-w-4xl mx-auto w-full py-12">
          ...
          <div className="text-center mb-8">
            <p className="text-muted-foreground/60 text-sm tracking-wider">
              时光倒转·命运重启
            </p>
          </div>
          ...
          <div className="text-center mb-16 space-y-4">
            <h1 className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent tracking-wide">
              云州纪事
            </h1>
            ...
            {sections.map((section) => {
              ...
              return (
                <Link key={section.id} to={section.path}>
                  <Card className="group relative overflow-hidden bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-500 hover:shadow-card hover:-translate-y-1 cursor-pointer h-full aspect-square">
                    {/* 背景渐变 */}
