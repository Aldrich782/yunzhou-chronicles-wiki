        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <Card className="p-8 bg-card/50 backdrop-blur-sm border-border/50 shadow-card">
            <div className="flex gap-6 items-start">
              {/* 左侧门派图标 */}
              <div className="flex-shrink-0 w-32 h-32 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
                <Scroll className="w-16 h-16 text-primary/60" />
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {zixiaoLandmarks.map((landmark) => (
                  <Link key={landmark.id} to={`/landmark/${landmark.id}`}>
                    <Card className="group overflow-hidden bg-gradient-to-br from-primary/5 to-accent/5 border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-soft hover:-translate-y-1 cursor-pointer">
                      {/* 缩略图 */}
